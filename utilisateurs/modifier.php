...
<?php // Si la méthode HTTP est différente de POST
if ($_SERVER['REQUEST_METHOD'] === 'POST') { ?> 
    ...
    if (!empty($_POST['password'])) {
        ...
        $stmt = $db->prepare($sql);
        $stmt->execute([
            ':mot_de_passe' => password_hash($_POST['password'], PASSWORD_DEFAULT), // Hash du mot de passe
            ':id' => $id 
        ]);
    }

    echo "<p style='color:green'>Modification effectue avec succes</p>";
